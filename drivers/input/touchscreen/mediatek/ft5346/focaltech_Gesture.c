...
{
	input_set_capability(input_dev, EV_KEY, 116);
	input_set_capability(input_dev, EV_KEY, 103);
	input_set_capability(input_dev, EV_KEY, 108);
	input_set_capability(input_dev, EV_KEY, 105);
	input_set_capability(input_dev, EV_KEY, 106);
	input_set_capability(input_dev, EV_KEY, 24);
	input_set_capability(input_dev, EV_KEY, 18);
	input_set_capability(input_dev, EV_KEY, 50);
	input_set_capability(input_dev, EV_KEY, 38);
	input_set_capability(input_dev, EV_KEY, 17);
	input_set_capability(input_dev, EV_KEY, 31);
	input_set_capability(input_dev, EV_KEY, 47);
	input_set_capability(input_dev, EV_KEY, 44);
	input_set_capability(input_dev, EV_KEY, 46);
	
	__set_bit(116, input_dev->keybit);
	__set_bit(103, input_dev->keybit);
	__set_bit(108, input_dev->keybit);
	__set_bit(105, input_dev->keybit);
	__set_bit(106, input_dev->keybit);
	__set_bit(24, input_dev->keybit);
	__set_bit(18, input_dev->keybit);
	__set_bit(50, input_dev->keybit);
	__set_bit(38, input_dev->keybit);
	__set_bit(17, input_dev->keybit);
	__set_bit(31, input_dev->keybit);
	__set_bit(47, input_dev->keybit);
	__set_bit(44, input_dev->keybit);
	__set_bit(46, input_dev->keybit);
...
{
	int gesture;
	printk("rn4x, gesture_id = %d", gesture_id);
	switch (gesture_id) {
		case 32:
			gesture = 105;
			break;
